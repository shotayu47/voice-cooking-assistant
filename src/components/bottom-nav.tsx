...
export function BottomNav() {
  ...
  return (
    <nav
      /*
       * A flex footer in the app shell, not a fixed overlay — see
       * `(app)/layout.tsx`. `shrink-0` keeps it at its natural height when the
       * content area is tall, and the safe-area padding keeps the row of
       * labels clear of the iPhone home indicator.
       */
